...
html.setAttribute(
  "style",
  "display: flex; height: 100%; width: 100%; margin: 0; padding: 0; color: black;"
);

const body = document.getElementsByTagName("body")[0];
body.setAttribute(
  "style",
  "margin: 0; padding: 0; height: 100%; color: black; display: flex; width: 100%; "
);

const container = document.createElement("div");
container.setAttribute(
  "style",
  "margin: 0; width: 100%; display: flex; background: black; justify-content: center; flex-direction: column; flex: 1; align-items: center;"
);
...
gif.onmouseover = function () {
  ...
  if (titleExists == true) {
    ...
    banner.textContent =
      "Ready for a good old fashioned cowboy shootout? Click the saloon doors!";
    banner.setAttribute(
      "style",
      "background-color: black; max-width: 40%; margin: 24px; text-align: center; font-family: courier new, sans-serif; color: white; display: flex; justify-content: center; align-items: center; font-weight: extra bold; font-size: 32px; border: 5px; wrap: no-wrap;"
    );
  }
};
...
function createGame() {
  ...
  function setMessage() {
    if (gameOver == false) {
      if (computerWins > playerWins) {
        return (
          endRoundUpdate +
          " Don't give up! The golden lasso could still be yours..."
        );
      } else if (computerWins == playerWins && computerWins + playerWins > 0) {
        return (
          endRoundUpdate +
          " It's a close one! Stay on your toes - your opponent's a straight shooter."
        );
      } else if (playerWins > computerWins) {
        return (
          endRoundUpdate +
          " You're ahead for now, but don't get cocky, partner!"
        );
      } else
        return (
          endRoundUpdate +
      ...
      if (computerWins > playerWins) {
        ...
        return (
          endRoundUpdate + " You won! There's a new sheriff in town...for now."
        );
    }
  ...
  function createPlayAgainBtn() {
    ...
    newRound.setAttribute(
      "style",
      "font-family: courier new, sans-serif; padding: 4px; background: #ec965d; margin: 16px"
    );
  ...
  function playRound(playerSelection, score) {
    ...
    if (gameOver == true) {
      ...
      endRoundUpdate =
        "You tie! " + playerSelection + " ties with " + computerSelection + "!";
    } else if (
  ...
  function calculateScore(score) {
    score.textContent = "Comp Score: " + computerWins;
  ...
  title.setAttribute(
    "style",
    "text-align: center; margin-top: 64px; margin-bottom: 12px; background-color: black; font-family: courier new, sans-serif; color: white; display: flex; justify-content: center; align-items: center; font-weight: extra bold; font-size: 32px; border: 5px; wrap: no-wrap;"
  );
  ...
  messageboard.setAttribute(
    "style",
    "background-color: black; text-align: center; display: flex; justify-content: center; margin-top: 16px;"
  );
  ...
  message.setAttribute(
    "style",
    "display: flex; justify-content: center; align-items: center; color: white; text-align: center; font-family: courier new, sans-serif;"
  );
  ...
  arena.setAttribute(
    "style",
    "background-color: black; text-align: center; display: flex; justify-content: center; margin-left: 16px; margin-right: 16px;"
  );
  ...
  arenaCenter.setAttribute(
    "style",
    "display: flex; flex-direction: column; font-size: 64px; color: white;"
  );
  ...
  scoreboard.setAttribute(
    "style",
    "font-family: courier new, sans-serif; background: black; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 16px; padding-top: 0px;"
  );
  ...
  myScore.textContent = "Your Score: " + playerWins;
  myScore.setAttribute(
    "style",
    "font-family: courier new, sans-serif; background: #e4743c; display: flex; justify-content: center; padding: 16px;"
  );
  scores.appendChild(myScore);

  let compScore = document.createElement("p");
  scores.classList.add("compScore");
  compScore.setAttribute(
    "style",
    "font-family: courier new, sans-serif; background: #e4743c; display: flex; justify-content: center; margin: 16px; padding: 16px;"
  );
  ...
  winnerDisplayContainer.setAttribute(
    "style",
    "font-family: courier new, sans-serif; text-align: center; font-size: 24px; max-height: 100%; background: #e4743c; padding: 5x; border: 6px black solid; "
  );
  ...
  winnerDisplay.setAttribute(
    "style",
    "font-family: courier new, sans-serif; text-align: center; margin: 0; font-size: 64px; max-height: 100%;"
  );
  ...
  buttons.setAttribute(
    "style",
    "font-family: courier new, sans-serif; justify-content: center; display: flex; margin-bottom: 64px; background: black;"
  );
